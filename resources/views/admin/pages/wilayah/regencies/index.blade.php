...
<div class="row mb-4">
    <div class="col-lg-3 col-6">
        <div class="small-box" style="background-color: #F5E8C7;">
            <div class="inner">
                <h3 style="color: #1B1A55;">{{ $regencies->total() }}</h3>
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box" style="background-color: #F5E8C7;">
            <div class="inner">
                <h3 style="color: #1B1A55;">{{ App\Models\Village::count() }}</h3>
                <p style="color: #1B1A55;">Total Kelurahan</p>
            </div>
            <div class="icon">
...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools d-flex align-items-center">
            <div class="input-group input-group-sm mr-3" style="width: 250px;">
                <input type="text" class="form-control" placeholder="Cari kabupaten/kota..." id="searchInput">
            ...
            <a href="{{ route('admin.regencies.create') }}" class="btn btn-sm" style="background-color: #1B1A55; color: white; border-color: #1B1A55;">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $regency->name }}</td>
                        <td>
                            <a href="{{ route('admin.regencies.edit', $regency) }}" class="btn btn-sm" style="background-color: #F5E8C7; color: #1B1A55; border-color: #F5E8C7;">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.regencies.destroy', $regency) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
    ...
    <div class="card-footer d-flex justify-content-end align-items-center" style="padding: 10px 20px; background-color: #fafafa; border-top: 1px solid #e0e0e0; font-size: 14px; color: #666;">
        <span class="mr-3">Showing {{ $regencies->firstItem() }} to {{ $regencies->lastItem() }} of {{ $regencies->total() }} results</span>
        {{ $regencies->links('pagination::compact') }}
    </div>
</div>
@endsection
